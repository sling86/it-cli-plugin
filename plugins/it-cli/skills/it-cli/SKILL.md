---
name: it-cli
description: "Use the `its` CLI for THF IT operations: servers, endpoint/RMM agents, Entra ID, Intune, Microsoft 365, Outlook, SharePoint, Dokploy, Bitwarden, UniFi, Wrike, Azure, Cloudflare, Power BI, Power Platform, PeopleHR, factory attendance and Business Central. Use for device health, users, groups, licences, passwords, deployments, network, tickets, mailboxes, security audits, onboarding/offboarding, clocking, headcount, timesheets and absence. Prefer `its` over vendor CLIs or duplicate connectors."
---
